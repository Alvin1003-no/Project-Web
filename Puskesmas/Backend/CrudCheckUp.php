                ...
                <ul
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item" href="CrudPasien.php">Daftar Pasien Check Up</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    if ($CariData) {
        ...
        $Query = mysqli_query($Connection, "
            ...
            WHERE nama_lengkap LIKE '%$keyword%' 
               OR nik LIKE '%$keyword%'
        ");
        // pilih semua data dari tabel medical_checkup dimana nama_lengkap mirip dengan keywordnya 
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?= $Nomor++ ?></td>
                            <td><?= $ShowData['nama_lengkap'] ?></td>
                            <td><?= $ShowData['usia'] . " Tahun" ?></td>
                            <td><?= $ShowData['berat_badan'] . " Kg"?></td>
                            <td><?= $ShowData['nik'] ?></td>
                            <td><?= $ShowData['pekerjaan'] ?></td>
                            <td><?= $ShowData['gaya_hidup'] ?></td>
                            <td><?= $ShowData['riwayat_penyakit'] ?></td>
                            <td><?= $ShowData['riwayat_alergi'] ?></td>
                            <td><?= $ShowData['created_at'] ?></td>
                            <td>
                                <a href="DeleteDataCheckUp.php?id_checkup=<?= $ShowData['id_checkup'] ?>"
                                    class="Hapus"
                                    onclick="return confirm('Apakah Anda Yakin Menghapus Data <?= $ShowData['nama_lengkap'] ?> ?')">
    ...
    ?>
        ...
        <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                    $Nomor = 1;
                    $Query = mysqli_query($Connection, "SELECT * FROM medical_checkup");
                    while ($ShowData = mysqli_fetch_array($Query)) {
                    ?>
                        <tr>
                            <td><?= $Nomor++ ?></td>
