...
<head>
    ...
    <title>Puskesmas Kartasura | Ambil Antrian</title>
</head>
            ...
            <ul
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="LokasiPuskesmas.html">Lokasi Kami</a>
                        </li>
                        <li><a class="dropdown-item" href="VisiMisi.html">Visi dan Misi</a></li>
                        <li>
                            <a class="dropdown-item" href="TentangPuskesmas.html">Tentang Kami</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a
                        class="nav-link active"
                        aria-current="page"
                        href="DaftarOnline.html"><span class="hover-underline-animation center">Daftar Online</span></a>
                </li>
                <li class="nav-item">
                    <a
                        class="nav-link active"
                        aria-current="page"
                        href="JadwalDokter.html"><span class="hover-underline-animation center">Jadwal Dokter</span></a>
                </li>
                <li class="nav-item">
...
<div class="banner-card">
    ...
    <div class="banner-text">
        <p class="Welcome">AMBIL ANTRIAN</p>
...
<div class="Youtube">
    <iframe src="https://www.youtube.com/embed/YEAq10ZdbdU?si=K0hut46DeQ6Gj1GO&amp;start=1025" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>

<div class="KotakJudul2">
    <p class="Kjudul">
        Poliklinik Ibu & Anak
    </p>
</div>
...
<!-- a href akan redirect ke login.php dengan membawa url poli tujuan dan akan membawa user ke halaman yang dituju user -->
<!-- %20 itu adalah spasi dalam url -->

<div class="KotakJudul3">
    <p class="Kjudul">
        Medical Checkup
    </p>
</div>
